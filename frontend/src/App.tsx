...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {page === 'dashboard-settings' && claims.role === 'admin' && <DashboardSettingsPage token={token} />}
      {page === 'dashboard-settings' && claims.role !== 'admin' && (
        <div className="flex items-center justify-center h-full">
          <div className="text-center text-gray-400">
            <svg className="w-12 h-12 mx-auto mb-4 opacity-30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            ...
            <p className="text-sm font-medium">Admin access required</p>
            <p className="text-xs mt-1">Dashboard Sources is only available to admin role users.</p>
          </div>
        </div>
      )}
